...
public class Instantiation implements CommandLineRunner {
	...
	public void run(String... args) throws Exception {
		...
		Post post1 =  new Post(null, sdf.parse("21/03/2022"), "Holidays", "I am going to Ireland, Ihaaa", maria);
		Post post2 =  new Post(null, sdf.parse("22/03/2022"), "Good morning", "I am so happy today", maria );
